...
class AddMecanicien extends StatefulWidget {
  const AddMecanicien({super.key});

  @override
  State<AddMecanicien> createState() => _AddMecanicienState();
}

class _AddMecanicienState extends State<AddMecanicien> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text("Ajouter un mécanicien",
